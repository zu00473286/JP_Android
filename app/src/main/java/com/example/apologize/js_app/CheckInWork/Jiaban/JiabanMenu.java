...
public class JiabanMenu extends BaseActivity{
    Button sub1,sub2,sub3;
    Handler myHandler = new Handler();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_jiaban_menu);
        findViews();
        didSetLanguage();
    }
    void findViews(){
        ...
        sub1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent();
                i.setClass(JiabanMenu.this, JiabanRequest.class);
                startActivity(i);
            }
        });
                            ...
                            public void run() {
                                if(db.dateArray.length() > 0){
                                    try{
                                        ...
                                        Intent i = new Intent();
                                        Bundle b = new Bundle();
                                        i.setClass(JiabanMenu.this, JiabanSearchCondition.class);
                            ...
                            public void run() {
                                if(db.dateArray.length() > 0){
                                    try{
                                        ...
                                        if(o.getString("dakacheck").equals("true")){
                                            Intent i = new Intent();
                                            i.setClass(JiabanMenu.this, JiabanAuditCondition.class);
                                            startActivity(i);
                                        }else{
                                            new AlertDialog.Builder(JiabanMenu.this)
        ...
        sub3.setOnLongClickListener(new View.OnLongClickListener() {
            ...
            public boolean onLongClick(View view) {
                Intent i = new Intent();
                i.setClass(JiabanMenu.this,CheckinAuthorityLoginView.class);
                startActivity(i);
                return false;
            }
        });
    ...
    void didSetLanguage(){
        ...
        sub1.setText(Common.toLanguage("加班申請"));
        sub2.setText(Common.toLanguage("加班查詢"));
        sub3.setText(Common.toLanguage("加班審核"));
