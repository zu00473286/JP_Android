...
public class LeaveSearchCondition extends BaseActivity {
    ...
    ArrayList<String> employename,date1,date2,time1,time2,bid,requestdate,result;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.leave_search_condition);
        findView();
    }
    ...
    void findView(){
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(LeaveSearchCondition.this,R.layout.spinnerview,items);
    ...
    void onSearch(){
        ...
        sb.append("select qjno,qjdate,result,udate,yndate,uontime,ynofftime,employename from qingjia where " + ss.toString() + " udate>=@date1 and yndate<=@date2 and result=@result order by qjdate desc");
                ...
                myHandler.post(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (connectOK) {
                            ...
                            i.putExtras(b);
                            i.setClass(LeaveSearchCondition.this,Leave_Search_View.class);
                            startActivity(i);

                        } else {
                            new AlertDialog.Builder(LeaveSearchCondition.this)
    ...
    View.OnClickListener employePick = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            Intent i = new Intent(LeaveSearchCondition.this,EmployeAttendance_Search.class);
            Bundle b = new Bundle();
