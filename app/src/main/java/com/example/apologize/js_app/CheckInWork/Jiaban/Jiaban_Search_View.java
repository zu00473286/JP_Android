...
import com.example.apologize.js_app.CheckInWork.Leave.LeaveSearchResult;
...
public class Jiaban_Search_View extends BaseActivity {
    ...
    void findView(){
        ...
        ArrayList<String> Employename,Jid,JbDate,date2,addtime1,addtime2,result;
    ...
    void setListView(){
        ...
        da = new SimpleAdapter(this,maps,R.layout.list_cell_for_five_lines,new String[]{"","","","",""},new int[]{R.id.line1,R.id.line2,R.id.line3,R.id.line4,R.id.line5})  {
            ...
            public View getView (final int position, View convertView, ViewGroup parent) {
                ...
                ((TextView)v.findViewById(R.id.line2)).setText(Common.toLanguage("加班日期") + ": " + maps.get(position).get("JbDate").toString());
                ((TextView)v.findViewById(R.id.line3)).setText(Common.toLanguage("時間起") + ": " + maps.get(position).get("addtime1").toString());
                ((TextView)v.findViewById(R.id.line4)).setText(Common.toLanguage("時間迄") + ": " + maps.get(position).get("addtime2").toString());
                String result = "";
                ...
                v.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtras(b);
                        i.setClass(Jiaban_Search_View.this, JiabanSearchResult.class);
