...
public class Leave_Search_View extends BaseActivity {
    ...
    void setListView(){
        ...
        da = new SimpleAdapter(this,maps,R.layout.list_cell_for_five_lines,new String[]{"","","","",""},new int[]{R.id.line1,R.id.line2,R.id.line3,R.id.line4,R.id.line5})  {
            ...
            public View getView (final int position, View convertView, ViewGroup parent) {
                ...
                ((TextView)v.findViewById(R.id.line4)).setText(Common.toLanguage("申請時間") + ": " + maps.get(position).get("requestdate").toString());
                String result = "";
                ...
                v.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        i.putExtras(b);
                        i.setClass(Leave_Search_View.this,LeaveSearchResult.class);
